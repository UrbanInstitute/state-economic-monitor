...
var semConfig = {
	"ScatterPlots":{
		...
		"Figure3":{
					...
					"subtitle": "National house prices in {{y-date-updated}} were still {{y-usa-value}} percent below the peak in house prices during the first quarter of 2007.",
