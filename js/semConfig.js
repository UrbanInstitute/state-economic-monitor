...
var semConfig = {
	"ScatterPlots":{
		...
		"Figure3":{
					...
					"subtitle": "National house prices in the second quarter of 2015 were still 2.4 percent below the peak in house prices during the first quarter of 2007.",
	...
	"Maps":{
		...
		"TOTAL":	{
					...
					"short-label": "CHANGE",
					"date-format": "quarter",
					"subtitle": "Total state tax revenue {{usa-changed}} in the year ending in the second quarter of 2015 compared to one year earlier.",
					"unit": "percent change year over year",
					"unit-type": "percent",
					"date-updated": "11/2014",
					"breaks": ["{{min}}",-2,0,3,6,"{{max}}"],
					"source": "<a href = 'http://www.census.gov/govs/qtax/'>US Census Bureau.</a><br>Note: Four quarters ending in the second quarter of 2015 are compared with four quarters ending in {{date-previous}}."
				},
		"INC":	{
					...
					"source": "<a href = 'http://www.census.gov/govs/qtax/'>US Census Bureau.</a><br>Note: Four quarters ending in the second quarter of 2015 are compared with four quarters ending in the {{date-previous}}."
				},
		"CORPINC":	{
