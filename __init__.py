...
def update_SEM():
  ...
  os.system("/usr/bin/depict http://sem.urban.org/employment.html --delay 5000  -H .pdfhide /var/www/apps.urban.org/semApp/archive/employment" +empName+ ".pdf")
  ...
  os.system("/usr/bin/depict http://sem.urban.org/housing.html --delay 5000 -H .pdfhide /var/www/apps.urban.org/semApp/archive/housing" +housingName+ ".pdf")
  ...
  os.system("/usr/bin/depict http://sem.urban.org/taxes.html --delay 5000 -H .pdfhide /var/www/apps.urban.org/semApp/archive/taxes" +taxesName+ ".pdf")
