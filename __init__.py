...
def update_SEM():
  ...
  os.system("depict http://sem.urban.org/employment.html -s '#figure_unemployment' -d 500 pdf/images/figure_unemployment.png")
  os.system("depict http://sem.urban.org/employment.html -s '#figure_level_vs_change_unemployment' -d 500 pdf/images/figure_level_vs_change_unemployment.png")
  os.system("depict http://sem.urban.org/employment.html -s '#figure_nonfarm-employment' -d 500 pdf/images/figure_nonfarm-employment.png")
  ...
  os.system("depict http://sem.urban.org/wages.html -s '#figure_wages' -d 500 pdf/images/figure_wages.png")
  os.system("depict http://sem.urban.org/wages.html -s '#figure_wages-change' -d 500 pdf/images/figure_wages-change.png")
  ...
  os.system("depict http://sem.urban.org/housing.html -s '#figure_house-prices' -d 500 pdf/images/figure_house-prices.png")
  os.system("depict http://sem.urban.org/housing.html -s '#housing_change_vs_2007_housing_change' -d 500 pdf/images/housing_change_vs_2007_housing_change.png")
  ...
  os.system("depict http://sem.urban.org/taxes.html -s '#figure_total-taxes' -d 500 pdf/images/figure_total-taxes.png")
  os.system("depict http://sem.urban.org/taxes.html -s '#figure_sales-taxes' -d 500 pdf/images/figure_sales-taxes.png")
  os.system("depict http://sem.urban.org/taxes.html -s '#figure_income-taxes' -d 500 pdf/images/figure_income-taxes.png")
